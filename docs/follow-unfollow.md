...
- Chưa tạo event outbox cho Follow/Unfollow hoặc sửa Redis feed lịch sử; đây
  là thay đổi cho quan hệ, bộ đếm và tính an toàn của API khi retry.
...
chiều; User cũ chưa có version; hết lượt retry và lỗi hệ thống.
